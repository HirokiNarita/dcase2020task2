...
from pytorch_utils import do_mixup, interpolate, pad_framewise_output, slide_augumentation
import numpy as np
...
class LSTM_AutoEncoder(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, fmax, aug_window_size, aug_hop_size):
    ...
    def forward(self, input, device='cuda:0', mixup_lambda=None):
        ...
        x = slide_augumentation(x, device, window_size=self.aug_window_size, hop_size=self.aug_hop_size)
        #print(x.shape)
