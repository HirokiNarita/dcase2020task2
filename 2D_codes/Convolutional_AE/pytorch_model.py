...
class CNN14AutoEncoder(nn.Module):
    """
        CNN14AutoEncoder
    """
    ...
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        ...
        super(CNN14AutoEncoder, self).__init__()
        ...
        self.neck1 = nn.Conv2d(2048, 10, kernel_size=3)
        self.neck2 = nn.ConvTranspose2d(10, out_channels=2048, kernel_size=3)
        ...
        self.deconv_block6 = deConvBlock(in_channels=64, out_channels=1)
    ...
    def forward(self, input, mixup_lambda=None):
        ...
        y = self.decoder(x)
        loss = F.mse_loss(y, logmel_spec_x)
